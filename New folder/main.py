...
if menu == 'Docs'
    ...
    if img is not None
        img = Image.open(img)
        try
            img.save('imagesimg.jpg')
        except
            img.save('imagesimg.png')
    ...
    if st.button('Encode data and Generate shares')
        ...
        # Generate splits
            ...
            try
                os.remove('imagesimg.jpg')
            except FileNotFoundError
                os.remove('imagesimg.png')
    ...
    if st.button('Compress shares and Decode message')
        ...
        # Compress shares
            ...
            compress_shares()
            os.remove('imagesshare1.png')
            os.remove('imagesshare2.png')
            st.success('Decoded message ' + lsb_decode('imagescompress.png'))